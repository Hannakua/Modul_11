...
def help():
    return "I am a bot. I accept the following commands: 'hello', 'add', 'change', 'show all', 'print pages', 'birth', 'exit', 'goodbye', 'close'. For 'add' or 'change' commands please enter the command in sequence: command user_name comma backspace user_number. For example: 'add Taras Kovalenko, 0676542345'"
